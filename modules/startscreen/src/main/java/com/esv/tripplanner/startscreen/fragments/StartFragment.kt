...
class StartFragment : com.esv.tripplanner.core_api.ui.InjectableFragment() {
    ...
    private lateinit var titleAnimation: ValueAnimator
    ...
    private fun runAppTitleAnimation() {
        val textIndexHolder = PropertyValuesHolder.ofInt(
            TITLE_INDEX,
            *(0..app_title.text.length).toList().toIntArray()
        )
        val srcTitleText = app_title.text
        titleAnimation = ValueAnimator().apply {
            ...
            addUpdateListener {
                ...
                spannableText.setSpan(
                    TextAppearanceSpan(
                        context,
                        com.esv.tripplanner.shared_ui.R.style.TitleSpannableTextStyle
                    ),
                    index,
                    if (index != srcTitleText.length) {
                        index + 1
                    } else {
                        index
                    },
    ...
    override fun performInjection() {
        StartComponent.createComponent(
